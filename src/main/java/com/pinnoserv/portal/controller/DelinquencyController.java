...
public class DelinquencyController {
    ...
    public ResponseEntity<?> viewById(@RequestBody() Map<String, Object> requestParams) {
        ...
        try {
            ...
            Optional<DelinquencyModel> deliquencySearch = delinquencyViewRepository.findByDeliquencyModelId(new Integer(delinquencyId));
            ...
            DelinquencyModel delinquencyEntity = deliquencySearch.get();
    ...
    public ResponseEntity<?> getDelinquencyByProductId(@RequestBody() Map<String, Object> requestParams) {
        ...
        try {
            List<DelinquencyModel> delinquency = delinquencyViewRepository.findAllByProductIdFk(new Integer(productId));
    ...
    public ResponseEntity<?> getAllDelinquency() {
        ...
        ApiResponse apiResponse = new ApiResponse();
        try {
            List<DelinquencyModel> deliquencys = delinquencyViewRepository.findAll();
